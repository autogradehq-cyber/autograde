...
const HomePage: NextPage = () => {
  ...
  <div className="rounded-2xl border border-slate-800 bg-slate-950 p-8 shadow-sm">
    ...
    <main className="min-h-screen bg-slate-950 text-slate-50">
      <div className="max-w-6xl mx-auto px-4 py-10 sm:py-14 space-y-12 sm:space-y-16">
        {/* Hero */}
        <section className="grid gap-10 lg:grid-cols-[3fr,2fr] items-center">
          <div>
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-semibold text-slate-50 mb-3 leading-tight">
              Smarter vehicle upgrades{" "}
              <span className="text-cyan-300">before you spend the money.</span>
            </h1>
            <p className="text-sm sm:text-base text-slate-300 max-w-xl mb-5">
              ...
              fitment risk, and send you straight to trusted retailers for parts
              that actually make sense for your build.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-3">
              <Link
                ...
                className="inline-flex items-center justify-center rounded-lg bg-cyan-400 px-4 py-2.5 text-sm font-semibold text-slate-950 shadow-lg shadow-cyan-500/40 hover:bg-cyan-300 transition-colors"
              >
              ...
              <Link
                ...
                className="inline-flex items-center justify-center rounded-lg border border-slate-700 bg-slate-900/70 px-4 py-2.5 text-sm font-semibold text-slate-100 hover:bg-slate-800/80 transition-colors"
              >
            ...
            <p className="text-[11px] text-slate-500">
              No spam and no random “mod list” fluff. Just a clear plan for your
              specific vehicle.
            </p>
          </div>

          {/* Side card: “How it works” */}
          <div className="rounded-2xl border border-slate-800 bg-slate-900/70 p-5 sm:p-6 shadow-[0_24px_60px_rgba(15,23,42,0.9)]">
        ...
        <section>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-4 sm:p-5 shadow-[0_20px_50px_rgba(15,23,42,0.9)]">
            ...
            <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-4 sm:p-5 shadow-[0_20px_50px_rgba(15,23,42,0.9)]">
              ...
              <p className="text-xs text-slate-300 mb-3">
                Compare your stock tire size to a new setup and get a rough look
                at diameter change, speedometer error, and rub risk.
              </p>
              <ul className="text-[11px] text-slate-400 space-y-1 mb-3 list-disc list-inside">
          ...
          <div className="grid gap-8 sm:grid-cols-2">
            ...
            <div>
              ...
              <p className="text-xs text-slate-300 mb-1.5">
                ...
                or Amazon, they may pay a small commission if you end up buying.
                That never changes your price.
              </p>
